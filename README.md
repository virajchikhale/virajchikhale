...
- 🔭 **Software Engineer @ Equations Work, Bavdhan** — building production AI agents with LangChain, LangGraph & CrewAI
- 🤖 Deep into **multi-agent systems**, RAG pipelines, LLM tool-calling, memory & fallback mechanisms
- 🔗 Lately working with **LiteLLM** for model-agnostic LLM routing and **MCP** for tool orchestration
- 📊 Love turning raw data into decisions — Power BI, Tableau, Streamlit dashboards
- 🎓 B.E. Artificial Intelligence — **CGPA 9.14/10** · Zeal College, Pune
- ⚡ Built FastAPI backends handling **10K+ daily requests** at sub-100ms latency
- 💬 Ask me about **LangChain agents · LiteLLM · FastAPI · PostgreSQL · Next.js**
...
![LiteLLM](https://img.shields.io/badge/LiteLLM-6933FF?style=flat-square&logoColor=white)
![MCP](https://img.shields.io/badge/MCP-0066CC?style=flat-square&logoColor=white)
...
|:---:|---|---|---|
| 🤖 | **AI Lead Qualification Agent** | LangChain · FastAPI · PostgreSQL | 40% better accuracy, 10K+ daily API requests |
| 🏥 | **Healthcare Sales Chatbot** | LangChain · Power BI | 500+ daily users, 25% higher satisfaction |
| 📍 | **Context-Aware Place Recommender** | Python · NLP · Geospatial | 85% accuracy, mood + location-aware |
| 🎬 | **Movie Recommendation System** | Scikit-learn · Streamlit · Embeddings | Hybrid filtering, 90%+ user satisfaction |
